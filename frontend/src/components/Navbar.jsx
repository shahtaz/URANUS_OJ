...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between item-center p-4 sm:p-6 sm:px-24 absolute top-0'>
      ...
      className='flex items-center gap-4 border border-gray-500
      rounded-full px-6 py-2 text-gray-800 hover:bg-gray-100 transitions-all'> login  <img src={assets.arrow_icon} alt="" /></button>
       </div>
       }
    </div>
  )
