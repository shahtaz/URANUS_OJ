...
const ResetPassword = () => {
  ...
  const handlePaste = (e) => {
    const paste = e.clipboardData.getData('text').slice(0, 7) // max 7 chars
  ...
  return (
    <div className='flex items-center justify-center h-screen sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
...
{!isEmailSent && 
      ...
      <form  onSubmit={onSubmitEmail}  action="" className='bg-slate-900 p-8 rounded-lg shadow-lg q-95 text-small '>
...
{!isOtpSubmited && isEmailSent && 
            <form onSubmit={onSubmitOtp} action=""  className='bg-slate-900 p-8 rounded-lg shadow-lg q-95 text-small '>
        <h1 className='text-white text-2xl font-semibold text-center mb-4'>reset password otp</h1>
        <p className='text-center mb-6 text-indigo-300'>enter the 7 digit code sent to your email id</p>
      ...
      {/* enter new password */}
{isOtpSubmited && isEmailSent &&
       <form onSubmit={onSubmitNewPassword} action="" className='bg-slate-900 p-8 rounded-lg shadow-lg q-95 text-small '>
